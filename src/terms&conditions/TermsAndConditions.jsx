  ...
  return (
    <section>
      ...
      <section style={{ width: "100%" }}>
        <div
          style={{ marginLeft: "60px", maxWidth: "100vw", marginRight: "50px" }}
        >
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Under no circumstances shall Famto team be liable for any direct,
            indirect, special, incidental or consequential damages, including,
            but not limited to, loss of data or profit, arising out of the use,
            or the inability to use, the materials on this site, even if Famto
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto will not be responsible for any outcome that may occur during
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto grants, you a revocable, non-exclusive, non- transferable,
            limited license to download, install and use the Famto strictly in
            accordance with the terms of this Agreement.
          </p>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            These Terms & Conditions are a contract between you and Famto
            (referred to in these Terms & Conditions as "Company", "us", "we" or
            "our"), the provider of the Famto website and the services
            accessible from the Famto  website (which are collectively referred
            to in these Terms & Conditions as the "Famto Service").
          </p>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            You are agreeing to be bound by these Terms & Conditions. If you do
            not agree to these Terms & Conditions, please do not use the Famto
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            <ul>
              <li>
                ...
                analytics, and remember information about you such as your
                language preference or login information.
              </li>
              <li>
                Company: When these terms mention "Company, "we," "us," or
                "our," it refers to Famto . Famto that is responsible for your
                information under these Terms & Conditions.
              </li>
              <li>
                Country: Where Famto or the owners/founders of Famto are based,
                in this case is Famto_
              </li>
              <li>
                Device: Any internet connected device such as a phone, tablet,
                computer or any other device that can be used to visit Famto and
                use the services.
              </li>
              <li>
                Service: This refers to the service provided by Famto as
                described in the relative terms (if available) and on this
                platform.
              </li>
              <li>
                Third-party service: This refers to advertisers, contest
                sponsors, promotional and marketing partners, and others who
                provide our content or whose products or services we think may
                interest you.
              </li>
              <li>
                Website: Famto site, which can be accessed via this URL:
                www.famto.in
              </li>
              <li>
                You: A person or entity that is registered with Famto to use the
                services
              </li>
            </ul>
          </p>
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            indicated in an order form, you must Provide Famto with a valid
            ...
            respect to your Payment Provider. By providing Famto with your
            credit card number and associated payment information, you agree
            that Famto is authorized to verify information immediately, and
            subsequently invoice your account for all fees and charges due and
            payable to Famto here under and that no additional notice or consent
            is required. You agree to immediately notify Famto of any change in
            your billing address or the credit card used for payment hereunder.
            <br />
            <ul>
              <li>
                Famto reserves the right at any time to change its prices and
                billing methods, either immediately upon posting on our Site or
                by e-mail delivery to your organization's administrator(s).
              </li>
              <li>
              ...
              <li>
                No contract will exist between you and Famto for the Service
                until Famto accepts your order by a confirmatory e-mail, SMS/MMS
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Thanks for shopping at Famto. We appreciate the fact that you like
            ...
            terms and conditions that apply to transactions at Famto We'll be as
            brief as our attorneys will allow. The main thing to remember is
            that by placing an order or making a purchase at Famto .you agree to
            the terms along with Famto's Privacy Policy. If, for any reason, You
            are not completely satisfied with any good or service that we
            provide, don't hesitate to contact us and we will discuss any of the
            issues you are going through with our Product.and Refund Policy.
          </p>
          <h3 style={{ textAlign: "left" }}>Your Suggestions</h3>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Any feedback, comments, ideas, improvements or suggestions
            (collectively, "Suggestions") provided by you to Famto with respect
            to the Famto shall remain the sole and exclusive property of Famto.
            Famto shall be free to use, copy, modify, publish, or redistribute
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            it's being used. By using our Famto. Registering an account, or
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            Famto. We are not responsible for the content, accuracy or opinions
            ...
            website, our Terms & Conditions are no longer in effect. Your
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto uses "Cookies" to identify the areas of our website that you
            ...
            enhance the performance and functionality of our Famto but are
            ...
            required to enter your login details every time you visit the Famto
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            You acknowledge and agree that Famto may stop (permanently or
            temporarily) providing the Service (or any features within the
            Service) to you or to users generally at Famto's sole discretion,
            without prior notice to you. You may stop using the Service at any
            time. You do not need to specifically inform Famto when you stop
            using the service. You acknowledge and agree that if Famto disables
            ...
            are contained in your account. If we decide to change our Terms &
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto reserves the right to modify, suspend or discontinue,
            temporarily or permanently,the Famto or any service to which it
            connects, with or without notice and without liability to you.
          </p>
          <h3 style={{ textAlign: "left" }}>Updates To Our Famto</h3>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto may from time to time provide enhancements or improvements to
            the features/functionality of the Famto which may include patches,
            ...
            of the Famto. You agree that Famto has no obligation to (i) provide
            any Updates, or (i continue to provide or enable any particular
            features and/or functionalities of the Famto to you. You further
            agree that all Updates will be () deemed to constitute an integral
            part of the Famto, and (i) subject to the terms and conditions of
            this Agreement.
          </p>
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            ("Third- Party Services"). You acknowledge and agree that Famto
            ...
            Famto does not assume and shall not have any liability or
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            Famto. Famto may, in its sole discretion, at any time and for any or
            ...
            notice from Famto in the event that you fail to comply with any
            provision of this Agreement. You may also terminate this Agreement
            by deleting the Famto and all copies thereof from your computer.
            Upon termination of this Agreement, you shall cease all use of the
            Famto and delete all copies of the Famto from your computer.
            Termination of this Agreement will not limit any of Famto's rights
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            material on our Famto constitutes an infringement on your copyright,
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            You agree to indemnify and hold Famto and its parents, subsidiaries,
            ...
            Famto; (b) violation of this Agreement or any law or regulation; or
            (c) violation of any right of a third party.
          </p>
          <h3 style={{ textAlign: "left" }}>No Warranties</h3>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            The Famto is provided to you "AS IS" and "AS AVAILABLE" and with all
            faults and defects without warranty of any kind. To the maximum
            extent permitted under applicable law, Famto on its own behalf and
            ...
            express, implied, statutory or otherwise, with respect to the Famto,
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Without limitation to the foregoing,Famto provides no warranty or
            undertaking, and makes no representation of any kind that the Famto
            ...
            can or will be corrected. Without limiting the foregoing, neither
            Famto nor any. Famto provider makes any representation or warranty
            of any kind, express or implied: (i) as to the operation or
            availability of the Famto,or the information, content, and materials
            or products included thereon;(ii) that the Famto will be
            uninterrupted or error-free; (iii) as to the accuracy, reliability,
            or currency of any information or content provided through the Famto
            or (iv) that the Famto, its servers, the content, or e-mails sent
            from or on behalf of Famto are free of viruses, scripts, Trojan
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            liability of Famto and any of its suppliers under any provision of
            this Agreement and your exclusive remedy for all of the foregoing
            shall be limited to the amount actually paid by you for the Famto.
          </p>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            To the maximum extent permitted by applicable law, in no event shall
            Famto or its suppliers be liable for any special, incidental,
            ...
            or inability to use the Famto ,third-party software and/or
            third-party hardware used with the Famto, or otherwise in connection
            with any provision of this Agreement),even if Famto or any supplier
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            notices published by Famto on the Services, shall constitute the
            entire agreement between you and Famto concerning the Services. If
            ...
            such term or any other term, and Famto's failure to assert any right
            or provision under this Agreement shall not constitute a waiver of
            such right or provision. YOU AND Famto_AGREE THAT ANY CAUSE OF
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto reserves the right, at its sole discretion, to modify or
            ...
            sole discretion. By continuing to access or use our Famto after any
            revisions become effective, you agree to be bound by the revised
            terms. If you do not agree to the new terms, you are no longer
            authorized to use Famto.
          </p>
          <h3 style={{ textAlign: "left" }}>EntireAgreement</h3>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            The Agreement constitutes the entire agreement between you and Famto
            regarding your use of the Famto and supersedes all prior and
            contemporaneous written or oral agreements between you and Famto.
            You may be subject to additional terms and conditions that apply
            when you use or purchase other Famto's services, which Famto will
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            The Famto and its entire contents, features and functionality
            including but not limited to all information, software, text,
            displays, images, video and audio, and the design, selection and
            arrangement thereof), are owned by Famto,, its licensors or other
            providers of such material and are protected by Famto and
            ...
            permission of Famto, unless and except as is expressly provided in
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR FAMTO'S
            INTELLECTUAL PROPERTY RIGHTS.
          </p>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            The term"dispute" means any dispute, action, or other controversy
            between you and Famto concerning the Services or this agreement,
            whether in contract, warranty, tort, statute, regulation,ordinance,
            or any other legal or equitable basis. "Dispute" will be given the
            broadest possible meaning allowable under law.
          </p>
          <h3 style={{ textAlign: "left" }}>Notice to Dispute</h3>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            In the event of a dispute, you or Famto must give the other a Notice
            ...
            any Notice of Dispute via email to: Famto will send any Notice of
            Dispute to you by mail to your address if we have it, or otherwise
            to your email address. You and Famto will attempt to resolve any
            ...
            Famto may commence arbitration.
          </p>
          <h3 style={{ textAlign: "left" }}>Binding Arbitration</h3>
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            If you and Famto don't resolve any dispute by informal negotiation,
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            that such submissions will automatically be treated as non-
            confidential and non-proprietary and will become the sole property
            of Famto without any compensation or credit to you whatsoever. Famto
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto may, from time to time, include contests, promotions,
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            signed by an authorized representative of Famto, Famto will be
            ...
            breach or anticipatory breach by you. Famto operates and controls
            the Famto Service from its offices in Famto . The Service is not
            ...
            to access the Famto Service from other locations do so on their own
            ...
            Conditions (which include and incorporate the Famto Privacy Policy)
            contains the entire understanding, and supersedes all prior
            understandings, between you and concerning its subject matter, and
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            Famto is not responsible for any content, code or any other
            imprecision. Famto does not provide warranties or guarantees. In no
            event shall Famto be liable for any special, direct, indirect,
            ...
            of the Service. Famto reserves the right to make additions,
            deletions, or modifications to the contents on the Service at any
            time without prior notice. The Famto Service and its contents are
            provided "as is" and "as available" without any warranty or
            representations of any kind, whether express or implied. Famto is a
            distributor and not a publisher of the content supplied by third
            parties; as such,Famto exercises no editorial control over such
            ...
            merchandise provided through or accessible via the Famto Service.
            Without limiting the foregoing, Famto specifically disclaims all
            warranties and representations in any content transmitted on or in
            connection with the Famto Service or on sites that may appear as
            links on the Famto Service, or in the products provided as a part
            of, or otherwise in connection with, the Famto Service, including
            without limitation any warranties of merchantability, fitness for a
            particular purpose or non-infringement of third party rights. No
            oral advice or written information given by Famto or any of its
            ...
            change without notice. Without limiting the foregoing, Famto does
            not warrant that the Famto Famto_Service will be uninterrupted,
          ...
          <p style={{ textAlign: "left", fontFamily: "Poppins" }}>
            ...
            via link:{" "}
            <strong>
              <a href="http://www.famto.in">www.famto.in</a>
            </strong>
          </p>
        </div>{" "}
        <br />
