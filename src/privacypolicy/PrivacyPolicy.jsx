...
const PrivacyPolicy =() =>{
    return(
      ...
      <h3 style={{textAlign:"left"}}>3.Privacy Policy</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <li>To help you quickly find services or information that you are looking for;</li>  
      <li>To help us create content most relevant to you; </li>
      <li>To alert you to special offers, updated information and other new services available on our Site.</li> 
      </ul>
      </p>
      <h3 style={{textAlign:"left"}}>4.Third party services</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      Our services are designed to allow you to assign tasks to field workers, communicate with your field workers and customers (“Users”), and view information pertaining to your field workers’ activity. We do this in part using GPS and other sensors on devices running our applications. Some information is automatically collected from or about your users and field workers when you use our services and may include, for example, geographic coordinates, phone numbers, names, and addresses.
      </p>
      <h3 style={{textAlign:"left"}}>5.Consent</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <h3 style={{textAlign:"left"}}>6.Access</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      We will provide you with the means to ensure that your Personal Information is correct and current. You may review and update this information at any time at the login section.<br/>There, you can:  
      <ul>
        ...
        <li>Sign up for electronic newsletters about our services and products; and Register.</li>
        <li> Once you register, you won’t need to do it again. Wherever you go on the Site, your information stays with you.</li> 
      </ul>
      </p>
      <h3 style={{textAlign:"left"}}>7.Security</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      7.2 Since this is an ‘information only site’, we do not guarantee your e-commerce transactions to be entirely safe and secure. If you make a financial transaction through our affiliate / connected web links, you must ensure that you are: a) compliant with the linked website’s terms of use; and b) have agreed to their privacy policy and online security framework. Should infringement or violation happen as a result of you accessing web pages that have been listed on our Site, we do not take responsibility for any security lapse.
      </p>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      7.3 You also have a significant role in protecting your information. No one can see or edit your Personal Information without knowing your user name and password, so do not share these with others. 
      </p>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      7.4 Data Security: In addition to the above, we will maintain security procedures and practices to store in a secure fashion and protect all personally identifiable information regarding the end user (<span style={{color:"black", fontWeight:"bold",fontFamily:"sans-serif"}}>“PII”</span>) that is collected by us and stored in a database owned or controlled by us the ( <span style={{color:"black", fontWeight:"bold", fontFamily:"sans-serif"}}>“Database”</span>), against accidental or unlawful destruction or loss, unauthorized disclosure or access. Such security procedures and practices shall be implemented in accordance with all applicable data protection laws and shall be appropriate to the nature of the information collected and shall be aligned with industry standard practices for the management, transport, and storage of PII.
      </p>
      <h3 style={{textAlign:"left"}}>8.Notice to parents</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      8.1 We want to help you guard your children’s privacy. We encourage you to talk to your children (below 13 years) about safe and responsible use of their Personal Information while using our Site. The Site does not publish content that is harmful, derogatory or pornographic in nature. However, the Website shall not incur any liability should your children provide us any Personal Information without parental consent. If you become aware that a child has provided us with personal information without parental consent, please contact us. If we become aware that a child under 13 has provided us with Personal Information without parental consent, we take steps to remove such information and terminate the child’s account.  
      </p><h3 style={{textAlign:"left"}}>9.Registration</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <h3 style={{textAlign:"left"}}>10.Customer profiles</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <h3 style={{textAlign:"left"}}>11.What we do with the information you share</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      11.2 We will disclose your Personal Information, without notice, only if required to do so by law or in the good faith belief that such action is necessary to: (a) confirm to the edicts of the law or comply with legal process served on the Site; (b) protect and defend the rights or property of ours; and (c) act in urgent circumstances to protect the personal safety of our users or the public. 
      </p>
      <h3 style={{textAlign:"left"}}>12.Information sharing and disclosure</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      12.1 We do not rent or sell Personal Information about you with other people (save with your consent) or non-affiliated companies, except to provide services you’ve requested, under the following circumstances:  <br/>
      <ul>
      <li>We respond to court orders, legal proceedings or to establish or exercise our legal rights or defend against legal claims. </li>
      <li>We believe it is necessary to share information in order to investigate, prevent, or take action regarding illegal activities, suspected fraud, situations involving potential threats to the physical safety of any person, violations of the Website’s terms of use, or as otherwise required by law. </li>
      <li>We shall transfer information about you only if we are acquired by another company or individual. In this event, the Website will notify you before information about you is transferred and becomes subject to a different privacy policy. </li>
      <li>We may need to contact you to comply or co-operate with a legal request. For this purpose, we will use the email address provided to us by you. All communications sent by us at such email address shall be deemed to have been communicated to you.</li>
      </ul>
      </p>
      <h3 style={{textAlign:"left"}}>13.Confidentiality and security</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      ...
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      13.2 We follow generally accepted industry standards to protect the Personal Information submitted to us, both during transmission and once we receive it. However, no method of transmission over the Internet or via mobile device, or method of electronic storage, is 100% secure. Therefore, while we strive to use commercially acceptable means to protect your Personal Information, we cannot guarantee its absolute security.
      </p>
      <h3 style={{textAlign:"left"}}>14.Your consent</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      14.1 By using the Website and mobile app, you consent to the terms of our Privacy Policy and to the Site’s processing of Personal Information for the purposes given above as well as those explained..
      </p>
      <h3 style={{textAlign:"left"}}>15.Privacy policy concerns and grievance redressal mechanism</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
      15.1 If you have any grievance relating to the processing/usage of information provided by you or the Site’s Privacy Policy, you may email our grievance officer at our Site or write at the following address:<br/><br/>
      Legal Department <br/><span style={{color:"black", fontWeight:"bold", fontFamily:"sans-serif"}}>My Famto Private Limited</span><br/>Revathi, A-18, Lekshmi Nagar, <br/>Kesavadasapuram, Pattom P.O.<br/>Thiruvananthapuram, Kerala, India 695004 
      </p>
      <h3 style={{textAlign:"left"}}>16.Contact information</h3>
      <p style={{textAlign:"left", fontFamily:"Poppins"}}>
